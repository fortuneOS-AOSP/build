...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.fortune.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.fortune.device")
  script.PrintFortuneBanner(android_version, build_id, build_date,
